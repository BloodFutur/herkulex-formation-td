...
- OpenOCD
- gdb-multiarch (Ubuntu-based OS, Arch ask Nathan)
- cargo generate
...
- If you are not sure ask Ronan or Joel

## Tasks
- Work in pairs 
- Have fun
- Call Joel or Ronan in case of any problems

### Tasks ideas
- Set 50% speed on 1 servo
- Turn the servos one after the other (2 or 3 servos)
- Get the temperature of servos (1 or more)
- Set position of servos (1 or more)
- Get the position of servos
- Make servos lights blink like a Christmas Tree
- Make a robotic arm that can move discs representing parts of cakes
